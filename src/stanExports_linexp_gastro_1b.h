...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_linexp_gastro_1b");
    reader.add_event(50, 48, "end", "model_linexp_gastro_1b");
    return reader;
}
...
typedef model_linexp_gastro_1b_namespace::model_linexp_gastro_1b stan_model;
#endif

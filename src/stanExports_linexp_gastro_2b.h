...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 49, column 2 to column 47)",
                                                      ...
                                                      " (in 'string', line 86, column 4 to column 34)",
                                                      " (in 'string', line 87, column 4 to column 34)",
                                                      " (in 'string', line 85, column 23 to line 88, column 3)",
                                                      " (in 'string', line 85, column 2 to line 88, column 3)",
                                                      " (in 'string', line 52, column 2 to column 11)",
                                                      " (in 'string', line 53, column 2 to column 11)",
                                                      " (in 'string', line 54, column 2 to column 14)",
                                                      " (in 'string', line 55, column 2 to column 14)",
                                                      ...
                                                      " (in 'string', line 63, column 2 to column 30)",
                                                      " (in 'string', line 64, column 2 to column 28)",
                                                      " (in 'string', line 65, column 2 to column 33)",
                                                      " (in 'string', line 66, column 2 to column 34)",
                                                      " (in 'string', line 67, column 2 to column 26)",
                                                      " (in 'string', line 69, column 3 to column 19)",
                                                      " (in 'string', line 70, column 3 to column 19)",
                                                      " (in 'string', line 71, column 3 to column 34)",
                                                      " (in 'string', line 72, column 3 to column 34)",
                                                      " (in 'string', line 73, column 3 to column 66)",
                                                      " (in 'string', line 68, column 14 to line 74, column 3)",
                                                      " (in 'string', line 68, column 0 to line 74, column 3)",
                                                      " (in 'string', line 77, column 2 to column 46)",
                                                      " (in 'string', line 11, column 2 to column 11)",
                                                      ...
                                                      " (in 'string', line 20, column 4 to column 20)",
                                                      " (in 'string', line 21, column 11 to column 12)",
                                                      " (in 'string', line 21, column 4 to column 23)",
                                                      ...
                                                      " (in 'string', line 32, column 8 to column 21)",
                                                      " (in 'string', line 30, column 25 to line 33, column 7)",
                                                      " (in 'string', line 30, column 6 to line 33, column 7)",
                                                      " (in 'string', line 29, column 18 to line 34, column 5)",
                                                      " (in 'string', line 29, column 4 to line 34, column 5)",
                                                      " (in 'string', line 35, column 4 to column 23)",
                                                      " (in 'string', line 36, column 4 to column 31)",
                                                      " (in 'string', line 39, column 19 to column 27)",
                                                      " (in 'string', line 45, column 15 to column 23)",
                                                      " (in 'string', line 80, column 9 to column 17)",
                                                      " (in 'string', line 81, column 9 to column 17)",
                                                      " (in 'string', line 82, column 9 to column 17)"};
#include <stan_meta_header.hpp>
class model_linexp_gastro_2b final : public model_base_crtp<model_linexp_gastro_2b> {
 private:
  double lkj;
  int student_df;
  int n;
 ...
 public:
  ...
  inline std::string model_name() const final { return "model_linexp_gastro_2b"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_linexp_gastro_2b_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      for (int sym1__ = 1; sym1__ <= n_record; ++sym1__) {
        ...
        if (jacobian__) {
          ...
          assign(v0_1, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(v0_1[(sym1__ - 1)], 0, lp__),
            "assigning variable v0_1");
        } else {
          current_statement__ = 1;
          assign(v0_1, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(v0_1[(sym1__ - 1)], 0),
            "assigning variable v0_1");
        }}
      ...
      mu_kappa = DUMMY_VAR__;
      
      current_statement__ = 3;
      mu_kappa = in__.scalar();
      current_statement__ = 3;
      if (jacobian__) {
        current_statement__ = 3;
        mu_kappa = stan::math::lb_constrain(mu_kappa, 0, lp__);
      } else {
        current_statement__ = 3;
        mu_kappa = stan::math::lb_constrain(mu_kappa, 0);
      }
      ...
      rho = Eigen::Matrix<local_scalar_t__, -1, -1>(2, 2);
      stan::math::fill(rho, DUMMY_VAR__);
      
      Eigen::Matrix<local_scalar_t__, -1, 1> rho_in__;
      rho_in__ = Eigen::Matrix<local_scalar_t__, -1, 1>(((2 * (2 - 1)) / 2));
      stan::math::fill(rho_in__, DUMMY_VAR__);
      
      current_statement__ = 5;
      rho_in__ = in__.vector(((2 * (2 - 1)) / 2));
      current_statement__ = 5;
      if (jacobian__) {
        current_statement__ = 5;
        assign(rho, nil_index_list(),
          stan::math::corr_matrix_constrain(rho_in__, 2, lp__),
          "assigning variable rho");
      } else {
        current_statement__ = 5;
        assign(rho, nil_index_list(),
          stan::math::corr_matrix_constrain(rho_in__, 2),
          "assigning variable rho");
      }
      ...
      std::vector<Eigen::Matrix<local_scalar_t__, -1, 1>> cf;
      cf = std::vector<Eigen::Matrix<local_scalar_t__, -1, 1>>(n_record, Eigen::Matrix<local_scalar_t__, -1, 1>(2));
      stan::math::fill(cf, DUMMY_VAR__);
      
      current_statement__ = 7;
      for (int sym1__ = 1; sym1__ <= n_record; ++sym1__) {
        current_statement__ = 7;
        assign(cf, cons_list(index_uni(sym1__), nil_index_list()),
          in__.vector(2), "assigning variable cf");}
      Eigen::Matrix<local_scalar_t__, -1, -1> sigma_cf;
      sigma_cf = Eigen::Matrix<local_scalar_t__, -1, -1>(2, 2);
      stan::math::fill(sigma_cf, DUMMY_VAR__);
      
      current_statement__ = 9;
      assign(sigma_cf, nil_index_list(), quad_form_diag(rho, sigma_record),
        "assigning variable sigma_cf");
      {
        int rec;
        ...
        lp_accum__.add(lkj_corr_lpdf<propto__>(rho, lkj));
        current_statement__ = 25;
        lp_accum__.add(normal_lpdf<propto__>(v0_1, 1, 0.3));
        current_statement__ = 26;
        lp_accum__.add(multi_normal_lpdf<propto__>(cf, zeros, sigma_cf));
        current_statement__ = 27;
        lp_accum__.add(normal_lpdf<propto__>(mu_kappa, 0.8, 0.3));
        current_statement__ = 28;
        lp_accum__.add(normal_lpdf<propto__>(mu_tempt, 40, 20));
        ...
        lp_accum__.add(cauchy_lpdf<propto__>(sigma, 0., 0.1));
        ...
        for (int i = 1; i <= n; ++i) {
          ...
          temptr = (mu_tempt + cf[(rec - 1)][(1 - 1)]);
          current_statement__ = 35;
          kappar = (mu_kappa + cf[(rec - 1)][(2 - 1)]);
          current_statement__ = 36;
          assign(mu, cons_list(index_uni(i), nil_index_list()),
            ((v0r * (1 + ((kappar * minute[(i - 1)]) / temptr))) *
              stan::math::exp((-minute[(i - 1)] / temptr))),
...
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
        ...
        assign(sigma_record, cons_list(index_uni(sym1__), nil_index_list()),
          ...
          "assigning variable sigma_record");}
      double mu_kappa;
      mu_kappa = std::numeric_limits<double>::quiet_NaN();
      ...
      current_statement__ = 6;
      sigma = stan::math::lb_constrain(sigma, 0);
      std::vector<Eigen::Matrix<double, -1, 1>> cf;
      cf = std::vector<Eigen::Matrix<double, -1, 1>>(n_record, Eigen::Matrix<double, -1, 1>(2));
      ...
      for (int sym1__ = 1; sym1__ <= n_record; ++sym1__) {
        ...
        assign(cf, cons_list(index_uni(sym1__), nil_index_list()),
          in__.vector(2), "assigning variable cf");}
      Eigen::Matrix<double, -1, -1> sigma_cf;
      sigma_cf = Eigen::Matrix<double, -1, -1>(2, 2);
      stan::math::fill(sigma_cf, std::numeric_limits<double>::quiet_NaN());
      
      for (int sym1__ = 1; sym1__ <= n_record; ++sym1__) {
        vars__.emplace_back(v0_1[(sym1__ - 1)]);}
      for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
        vars__.emplace_back(sigma_record[(sym1__ - 1)]);}
      vars__.emplace_back(mu_kappa);
      ...
      for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
        for (int sym2__ = 1; sym2__ <= n_record; ++sym2__) {
          vars__.emplace_back(cf[(sym2__ - 1)][(sym1__ - 1)]);}}
      ...
      kappa = Eigen::Matrix<double, -1, 1>(n_record);
      ...
      for (int i = 1; i <= n_record; ++i) {
        ...
        assign(tempt, cons_list(index_uni(i), nil_index_list()),
          (mu_tempt + cf[(i - 1)][(1 - 1)]), "assigning variable tempt");
        current_statement__ = 15;
        assign(kappa, cons_list(index_uni(i), nil_index_list()),
          (mu_kappa + cf[(i - 1)][(2 - 1)]), "assigning variable kappa");}
      for (int sym1__ = 1; sym1__ <= n_record; ++sym1__) {
    ...
    try {
      ...
      for (int sym1__ = 1; sym1__ <= n_record; ++sym1__) {
        ...
        assign(v0_1_free__, cons_list(index_uni(sym1__), nil_index_list()),
          stan::math::lb_free(v0_1[(sym1__ - 1)], 0),
      ...
      double mu_kappa_free__;
      mu_kappa_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 3;
      mu_kappa_free__ = stan::math::lb_free(mu_kappa, 0);
      double mu_tempt;
      mu_tempt = std::numeric_limits<double>::quiet_NaN();
      ...
      rho_free__ = Eigen::Matrix<double, -1, 1>(((2 * (2 - 1)) / 2));
      ...
      {
        std::vector<local_scalar_t__> cf_flat__;
        current_statement__ = 7;
        assign(cf_flat__, nil_index_list(), context__.vals_r("cf"),
          "assigning variable cf_flat__");
        current_statement__ = 7;
        pos__ = 1;
        current_statement__ = 7;
        for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
          ...
          for (int sym2__ = 1; sym2__ <= n_record; ++sym2__) {
            ...
            assign(cf,
              cons_list(index_uni(sym2__),
                cons_list(index_uni(sym1__), nil_index_list())),
              cf_flat__[(pos__ - 1)], "assigning variable cf");
            current_statement__ = 7;
            pos__ = (pos__ + 1);}}
      }
      for (int sym1__ = 1; sym1__ <= n_record; ++sym1__) {
      ...
      vars__.emplace_back(mu_kappa_free__);
      ...
      for (int sym1__ = 1; sym1__ <= n_record; ++sym1__) {
        for (int sym2__ = 1; sym2__ <= 2; ++sym2__) {
          vars__.emplace_back(cf[(sym1__ - 1)][(sym2__ - 1)]);}}
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
      ...
      for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
        {
          for (int sym2__ = 1; sym2__ <= 2; ++sym2__) {
            {
              param_names__.emplace_back(std::string() + "sigma_cf" + '.' + std::to_string(sym2__) + '.' + std::to_string(sym1__));
            }}
        }}
    }
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"v0_1\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"parameters\"},{\"name\":\"sigma_record\",\"type\":{\"name\":\"vector\",\"length\":" << 2 << "},\"block\":\"parameters\"},{\"name\":\"mu_kappa\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu_tempt\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"matrix\",\"rows\":" << 2 << ",\"cols\":" << 2 << "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"cf\",\"type\":{\"name\":\"array\",\"length\":" << n_record << ",\"element_type\":{\"name\":\"vector\",\"length\":" << 2 << "}},\"block\":\"parameters\"},{\"name\":\"sigma_cf\",\"type\":{\"name\":\"matrix\",\"rows\":" << 2 << ",\"cols\":" << 2 << "},\"block\":\"transformed_parameters\"},{\"name\":\"v0\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"generated_quantities\"},{\"name\":\"tempt\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"generated_quantities\"},{\"name\":\"kappa\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
    } // get_constrained_sizedtypes() 
    
  inline std::string get_unconstrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"v0_1\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"parameters\"},{\"name\":\"sigma_record\",\"type\":{\"name\":\"vector\",\"length\":" << 2 << "},\"block\":\"parameters\"},{\"name\":\"mu_kappa\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu_tempt\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"vector\",\"length\":" << ((2 * (2 - 1)) / 2) << "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"cf\",\"type\":{\"name\":\"array\",\"length\":" << n_record << ",\"element_type\":{\"name\":\"vector\",\"length\":" << 2 << "}},\"block\":\"parameters\"},{\"name\":\"sigma_cf\",\"type\":{\"name\":\"matrix\",\"rows\":" << 2 << ",\"cols\":" << 2 << "},\"block\":\"transformed_parameters\"},{\"name\":\"v0\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"generated_quantities\"},{\"name\":\"tempt\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"generated_quantities\"},{\"name\":\"kappa\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_linexp_gastro_2b_namespace::model_linexp_gastro_2b;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_linexp_gastro_2b_namespace::profiles__;
}
#endif
#endif

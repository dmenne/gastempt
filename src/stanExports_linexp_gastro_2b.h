...
public:
  ...
  model_linexp_gastro_2b(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_linexp_gastro_2b_namespace::model_linexp_gastro_2b";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = n_record + 2 + 1 + 1 + ((2 * (2 - 1)) / 2) + 1 +
      (n_record * 2);
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_linexp_gastro_2b_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      v0_1 = in__.template read_constrain_lb<
      ...
      rho = in__.template read_constrain_corr_matrix<
      ...
      std::vector<Eigen::Matrix<local_scalar_t__,-1,1>> cf =
        std::vector<Eigen::Matrix<local_scalar_t__,-1,1>>(n_record,
          Eigen::Matrix<local_scalar_t__,-1,1>::Constant(2, DUMMY_VAR__));
      current_statement__ = 7;
      cf = in__.template read<
             std::vector<Eigen::Matrix<local_scalar_t__,-1,1>>>(n_record, 2);
      Eigen::Matrix<local_scalar_t__,-1,-1> sigma_cf =
        Eigen::Matrix<local_scalar_t__,-1,-1>::Constant(2, 2, DUMMY_VAR__);
      current_statement__ = 12;
      stan::model::assign(sigma_cf,
        stan::math::quad_form_diag(rho, sigma_record),
        "assigning variable sigma_cf");
      {
        ...
        lp_accum__.add(stan::math::lkj_corr_lpdf<propto__>(rho, lkj));
        current_statement__ = 25;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(v0_1, 1, 0.3));
        current_statement__ = 26;
        lp_accum__.add(stan::math::multi_normal_lpdf<propto__>(cf, zeros,
                         sigma_cf));
        current_statement__ = 27;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(mu_kappa, 0.8, 0.3));
        current_statement__ = 28;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(mu_tempt, 40, 20));
        ...
        lp_accum__.add(stan::math::cauchy_lpdf<propto__>(sigma, 0., 0.1));
        ...
        for (int i = 1; i <= n; ++i) {
          ...
          stan::model::assign(mu, ((v0r * (1 + ((kappar *
            stan::model::rvalue(minute, "minute", stan::model::index_uni(i)))
            / temptr))) *
            stan::math::exp(
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_linexp_gastro_2b_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      std::vector<Eigen::Matrix<double,-1,1>> cf =
        std::vector<Eigen::Matrix<double,-1,1>>(n_record,
          Eigen::Matrix<double,-1,1>::Constant(2,
            std::numeric_limits<double>::quiet_NaN()));
      current_statement__ = 7;
      cf = in__.template read<
      ...
      for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
        for (int sym2__ = 1; sym2__ <= n_record; ++sym2__) {
          out__.write(cf[(sym2__ - 1)][(sym1__ - 1)]);
        }
      }
      ...
      for (int i = 1; i <= n_record; ++i) {
        ...
        stan::model::assign(kappa, (mu_kappa +
          stan::model::rvalue(cf, "cf", stan::model::index_uni(i),
            stan::model::index_uni(2))), "assigning variable kappa",
          stan::model::index_uni(i));
      }
      out__.write(v0);
      out__.write(tempt);
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      out__.write_free_corr_matrix(rho);
      local_scalar_t__ sigma = DUMMY_VAR__;
      current_statement__ = 6;
      ...
      for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
        ...
        for (int sym2__ = 1; sym2__ <= n_record; ++sym2__) {
          current_statement__ = 7;
          stan::model::assign(cf, in__.read<local_scalar_t__>(),
            "assigning variable cf", stan::model::index_uni(sym2__),
  ...
  transform_inits_impl(const stan::io::var_context& context__, VecVar&
    ...
    try {
      ...
      context__.validate_dims("parameter initialization", "sigma", "double",
        std::vector<size_t>{});
      current_statement__ = 7;
      context__.validate_dims("parameter initialization", "cf", "double",
        std::vector<size_t>{static_cast<size_t>(n_record),
          ...
          Eigen::Matrix<local_scalar_t__,-1,1>::Constant(2, DUMMY_VAR__));
      {
        ...
        for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
          ...
          for (int sym2__ = 1; sym2__ <= n_record; ++sym2__) {
            current_statement__ = 7;
            stan::model::assign(cf, cf_flat__[(pos__ - 1)],
              "assigning variable cf", stan::model::index_uni(sym2__),
              stan::model::index_uni(sym1__));
            current_statement__ = 7;
            pos__ = (pos__ + 1);
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"v0_1", "sigma_record", "mu_kappa",
                "mu_tempt", "rho", "sigma", "cf"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"sigma_cf"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"v0", "tempt", "kappa"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
  }
  ...
  constrained_param_names(std::vector<std::string>& param_names__, bool
    ...
    if (emit_transformed_parameters__) {
      for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
        for (int sym2__ = 1; sym2__ <= 2; ++sym2__) {
          param_names__.emplace_back(std::string() + "sigma_cf" + '.' +
            std::to_string(sym2__) + '.' + std::to_string(sym1__));
        }
      }
    }
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"v0_1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"parameters\"},{\"name\":\"sigma_record\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"mu_kappa\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu_tempt\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(2) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"cf\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(n_record) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "}},\"block\":\"parameters\"},{\"name\":\"sigma_cf\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(2) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"v0\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"generated_quantities\"},{\"name\":\"tempt\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"generated_quantities\"},{\"name\":\"kappa\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"v0_1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"parameters\"},{\"name\":\"sigma_record\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"parameters\"},{\"name\":\"mu_kappa\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu_tempt\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(((2 * (2 - 1)) /2)) + "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"cf\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(n_record) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "}},\"block\":\"parameters\"},{\"name\":\"sigma_cf\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(2) + ",\"cols\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"v0\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"generated_quantities\"},{\"name\":\"tempt\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"generated_quantities\"},{\"name\":\"kappa\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((((((n_record + 2) + 1) + 1) + (2 * 2)) + 1)
      + (n_record * 2));

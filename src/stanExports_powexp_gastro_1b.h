...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 36, column 3 to column 22)",
                                                      " (in 'string', line 37, column 3 to column 24)",
                                                      " (in 'string', line 38, column 3 to column 47)",
...
class model_powexp_gastro_1b final : public model_base_crtp<model_powexp_gastro_1b> {
 private:
  double prior_v0;
  int n;
  int n_record;
 ...
 public:
  ...
  inline std::string model_name() const final { return "model_powexp_gastro_1b"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_powexp_gastro_1b_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      }
      {
        ...
        lp_accum__.add(normal_lpdf<propto__>(mu_beta, 1.5, 0.5));
        current_statement__ = 14;
        lp_accum__.add(normal_lpdf<propto__>(sigma_beta, 1, 0.5));
        current_statement__ = 15;
        lp_accum__.add(normal_lpdf<propto__>(v0, prior_v0, 100));
        current_statement__ = 16;
        lp_accum__.add(lognormal_lpdf<propto__>(beta, mu_beta, sigma_beta));
...
(void) function__;  // suppress unused var warning
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      beta_free__ = Eigen::Matrix<double, -1, 1>(n_record);
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"v0\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"parameters\"},{\"name\":\"tempt\",\"type\":{\"name\":\"vector\",\"length\":" << n_record << "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu_beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]";
    return s__.str();
...
using stan_model = model_powexp_gastro_1b_namespace::model_powexp_gastro_1b;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_powexp_gastro_1b_namespace::profiles__;
}
#endif
#endif

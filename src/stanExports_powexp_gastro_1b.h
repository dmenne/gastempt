...
public:
  ...
  model_powexp_gastro_1b(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_powexp_gastro_1b_namespace::model_powexp_gastro_1b";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_powexp_gastro_1b_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
                     ...
                     jacobian__>(0, lp__);
      {
        ...
        lp_accum__.add(stan::math::normal_lpdf<propto__>(mu_beta, 1.5, 0.5));
        current_statement__ = 14;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(sigma_beta, 1, 0.5));
        current_statement__ = 15;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(v0, prior_v0, 100));
        current_statement__ = 16;
        lp_accum__.add(stan::math::lognormal_lpdf<propto__>(beta, mu_beta,
                         sigma_beta));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_powexp_gastro_1b_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"v0", "beta", "tempt", "sigma",
                "mu_beta", "sigma_beta"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"v0\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"parameters\"},{\"name\":\"tempt\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_record) + "},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu_beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma_beta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]");
  }

...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_linexp_gastro_1d");
    reader.add_event(43, 41, "end", "model_linexp_gastro_1d");
    return reader;
}
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("kappa", "n_record", n_record);
        context__.validate_dims("parameter initialization", "kappa", "vector_d", context__.to_vec(n_record));
        ...
        if (!(context__.contains_r("sigma_kappa")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sigma_kappa missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sigma_kappa");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigma_kappa", "double", context__.to_vec());
        double sigma_kappa(0);
        sigma_kappa = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sigma_kappa);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sigma_kappa: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> mt(n);
            ...
            for (size_t j_1__ = 0; j_1__ < mt_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(mt(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: mt" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable mt: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            // model body
            {
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> vol(n);
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> kappa = in__.vector_lb_constrain(0, n_record);
        size_t kappa_j_1_max__ = n_record;
        for (size_t j_1__ = 0; j_1__ < kappa_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            current_statement_begin__ = 24;
            validate_non_negative_index("mt", "n", n);
            Eigen::Matrix<double, Eigen::Dynamic, 1> mt(n);
            stan::math::initialize(mt, DUMMY_VAR__);
            stan::math::fill(mt, DUMMY_VAR__);
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < mt_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "mt" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        if (!include_gqs__) return;
...
typedef model_linexp_gastro_1d_namespace::model_linexp_gastro_1d stan_model;
#endif
